      ...
      <a-row>
        <a-col :span="8">
          <a-form-item label="菜单名称">
            <a-input v-model:value="searchForm.menu_name" placeholder="请输入">
            </a-input>
          </a-form-item>
        </a-col>
        <a-col :span="8">
          <a-form-item label="菜单路由">
            <a-input
              v-model:value="searchForm.menu_router"
              placeholder="请输入"
            >
            </a-input>
          </a-form-item>
...
import { getMenuList, delMenu, changeStatus } from "../../api/menu";
